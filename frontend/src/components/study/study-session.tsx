...
import { useAppSettings } from "@/services/settings/app-settings-context";
import {
  evaluateStudyAnswer,
  getDueCards,
  getPracticeCards,
...
export function StudySession() {
  ...
  const welcomeKey = "easy-sks-study-welcome-seen";
          ...
          <>
            ...
            <div className="w-full max-w-3xl space-y-3 rounded-2xl border border-white/10 bg-card/80 p-4">
              <SpeechAnswerInput
                ...
                placeholder={
                  aiEnabled
                    ? "Formuliere deine Antwort und prüfe sie mit KI."
                    : "Formuliere deine Antwort als Notiz."
                }
              />
              ...
              {aiEnabled ? (
                ...
                <p className="text-xs text-muted-foreground">
                  KI-Bewertung ist deaktiviert.{" "}
                  <Link href="/settings" className="underline">
                    In den Einstellungen
                  </Link>{" "}
                  aktivieren und einen OpenAI-Key hinterlegen.
                </p>
              )}
            </div>
