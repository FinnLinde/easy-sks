...
export type ExamTemplate = components["schemas"]["ExamTemplateOut"];
export type ExamSession = components["schemas"]["ExamSessionOut"];
export type ExamSessionHistory = components["schemas"]["ExamSessionHistoryOut"];
export type ExamResult = components["schemas"]["ExamResultOut"];
